  ...
  View Leaderboard →
    ...
    `},initListeners(){const e=document.getElementById("btn-pipeline-add-lead");e&&e.addEventListener("click",()=>{window.dispatchEvent(new CustomEvent("techcrm:open-add-lead"))});const t=document.getElementById("pipeline-search");t&&t.addEventListener("input",s=>{this.currentSearch=s.target.value.toLowerCase().trim(),this.refreshBoard()});const n=document.getElementById("pipeline-filter-priority");n&&n.addEventListener("change",s=>{this.currentPriority=s.target.value,this.refreshBoard()});const i=document.getElementById("pipeline-filter-tech");i&&i.addEventListener("change",s=>{this.currentRequirement=s.target.value,this.refreshBoard()});const o=document.getElementById("pipeline-filter-date");o&&o.addEventListener("change",s=>{this.currentDateRange=s.target.value,this.refreshBoard()});const a=document.getElementById("btn-reset-filters");a&&a.addEventListener("click",()=>{this.currentSearch="",this.currentPriority="all",this.currentRequirement="all",this.currentDateRange="all";const s=document.getElementById("pipeline-search");s&&(s.value="");const r=document.getElementById("pipeline-filter-priority");r&&(r.value="all");const d=document.getElementById("pipeline-filter-tech");d&&(d.value="all");const c=document.getElementById("pipeline-filter-date");c&&(c.value="all"),this.refreshBoard()}),this.initColumnCustomizer(),this.bindKanbanInteractions()},initColumnCustomizer(){const e=document.getElementById("btn-toggle-column-menu"),t=document.getElementById("column-customize-dropdown"),n=document.getElementById("btn-submit-new-column"),i=document.getElementById("input-new-column-name");if(!e||!t)return;e.addEventListener("click",a=>{a.stopPropagation();const s=t.style.display==="none"||!t.style.display;t.style.display=s?"block":"none",s&&this.renderColumnCheckboxes()}),document.addEventListener("click",a=>{!t.contains(a.target)&&a.target!==e&&(t.style.display="none")}),this.renderColumnCheckboxes();const o=()=>{const a=i.value.trim();if(!a)return;const r={id:"stage_"+Date.now(),name:a,visible:!0},d=this.getStages();d.push(r),l.set(l.KEYS.PIPELINE_STAGES,d),i.value="",this.renderColumnCheckboxes(),this.refreshBoard(),u.show(`✓ Added column "${a}"`)};n&&n.addEventListener("click",o),i&&i.addEventListener("keydown",a=>{a.key==="Enter"&&(a.preventDefault(),o())})},renderColumnCheckboxes(){const e=document.getElementById("column-checkboxes-container");if(!e)return;const t=this.getStages(),n=["new","request_sent","connected","qualified","proposal","won"];e.innerHTML=t.map((a,s)=>{const r=n.includes(a.id);return`
      ...
      `}).join("");let i=null;const o=e.querySelectorAll(".col-drag-item");o.forEach(a=>{a.addEventListener("dragstart",s=>{i=parseInt(a.getAttribute("data-index"),10),s.dataTransfer.effectAllowed="move",a.style.opacity="0.4"}),a.addEventListener("dragend",()=>{a.style.opacity="1",o.forEach(s=>{s.style.borderTop="1px solid var(--border-subtle)",s.style.background="#F8FAFC"})}),a.addEventListener("dragover",s=>{s.preventDefault(),s.dataTransfer.dropEffect="move",a.style.background="#EEF2FF"}),a.addEventListener("dragleave",()=>{a.style.background="#F8FAFC"}),a.addEventListener("drop",s=>{s.preventDefault(),a.style.background="#F8FAFC";const r=parseInt(a.getAttribute("data-index"),10);if(i!==null&&i!==r){const d=this.getStages(),[c]=d.splice(i,1);d.splice(r,0,c),l.set(l.KEYS.PIPELINE_STAGES,d),this.renderColumnCheckboxes(),this.refreshBoard(),u.show(`✓ Column moved to position ${r+1}`)}})}),e.querySelectorAll(".column-visibility-toggle").forEach(a=>{a.addEventListener("change",s=>{const r=a.getAttribute("data-stage-id"),d=this.getStages(),c=d.find(p=>p.id===r);c&&(c.visible=s.target.checked,l.set(l.KEYS.PIPELINE_STAGES,d),this.refreshBoard())})}),e.querySelectorAll(".btn-move-col-up").forEach(a=>{a.addEventListener("click",s=>{s.stopPropagation();const r=parseInt(a.getAttribute("data-index"),10),d=this.getStages();if(r>0){const c=d[r];d[r]=d[r-1],d[r-1]=c,l.set(l.KEYS.PIPELINE_STAGES,d),this.renderColumnCheckboxes(),this.refreshBoard()}})}),e.querySelectorAll(".btn-move-col-down").forEach(a=>{a.addEventListener("click",s=>{s.stopPropagation();const r=parseInt(a.getAttribute("data-index"),10),d=this.getStages();if(r<d.length-1){const c=d[r];d[r]=d[r+1],d[r+1]=c,l.set(l.KEYS.PIPELINE_STAGES,d),this.renderColumnCheckboxes(),this.refreshBoard()}})}),e.querySelectorAll(".btn-delete-column").forEach(a=>{a.addEventListener("click",s=>{var p;s.stopPropagation();const r=a.getAttribute("data-stage-id");let d=this.getStages();if(n.includes(r)){u.show("Default columns cannot be deleted","warning");return}const c=((p=d.find(m=>m.id===r))==null?void 0:p.name)||"Column";d=d.filter(m=>m.id!==r),l.set(l.KEYS.PIPELINE_STAGES,d),this.renderColumnCheckboxes(),this.refreshBoard(),u.show(`✓ "${c}" removed`)})})},bindKanbanInteractions(){const e=document.getElementById("app");if(!e)return;e.querySelectorAll(".lead-card").forEach(n=>{n.addEventListener("click",()=>{if(n.classList.contains("is-dragging"))return;const i=n.getAttribute("data-id");i&&w.open(i)}),n.addEventListener("dragstart",i=>{this.draggedLeadId=n.getAttribute("data-id"),n.classList.add("is-dragging"),i.dataTransfer.effectAllowed="move",i.dataTransfer.setData("text/plain",this.draggedLeadId)}),n.addEventListener("dragend",()=>{n.classList.remove("is-dragging"),this.draggedLeadId=null,document.querySelectorAll(".drag-over").forEach(i=>i.classList.remove("drag-over"))})}),e.querySelectorAll(".kanban-column, .outcome-drop-zone").forEach(n=>{n.addEventListener("dragover",i=>{i.preventDefault(),i.dataTransfer.dropEffect="move",n.classList.add("drag-over")}),n.addEventListener("dragleave",i=>{n.contains(i.relatedTarget)||n.classList.remove("drag-over")}),n.addEventListener("drop",i=>{i.preventDefault(),n.classList.remove("drag-over");const o=i.dataTransfer.getData("text/plain")||this.draggedLeadId,a=n.getAttribute("data-stage");o&&a&&this.handleLeadDrop(o,a)})})},handleLeadDrop(e,t){const n=g.getById(e);if(!(!n||n.status===t))if(t==="lost")I.open(e);else{g.updateStatus(e,t);const i=t.replace("_"," ");u.show(`✓ Lead "${n.name}" moved to ${i.toUpperCase()}`),window.dispatchEvent(new CustomEvent("techcrm:data-changed"))}},refreshBoard(){if(document.querySelector(".kanban-wrapper")){const n=this.getStages().filter(s=>s.visible!==!1),o=g.getAll().filter(s=>{const r=!this.currentSearch||s.name&&s.name.toLowerCase().includes(this.currentSearch)||s.company&&s.company.toLowerCase().includes(this.currentSearch),d=this.currentPriority==="all"||s.priority===this.currentPriority,c=this.currentRequirement==="all"||Array.isArray(s.requirements)&&s.requirements.some(m=>m.toLowerCase().includes(this.currentRequirement.toLowerCase())),p=this.matchesDateRange(s);return r&&d&&c&&p}),a=document.getElementById("kanban-board-container");a&&(a.innerHTML=n.length===0?`
        ...
        `:n.map(s=>M.render(s,o)).join(""),this.bindKanbanInteractions())}}},oe={currentSection:"pipeline",render(){const e=l.get(l.KEYS.PIPELINE_STAGES,[]),t=[{name:"Neha Jain",role:"Sales / Fullstack Dev",leads:48,status:"Active",avatar:"NJ",isCurrent:!0},{name:"Aman Sharma",role:"Outreach Specialist",leads:37,status:"Active",avatar:"AS",isCurrent:!1},{name:"Priya Verma",role:"Agency Manager",leads:15,status:"Active",avatar:"PV",isCurrent:!1}];return`
      <div class="page-container">
        <!-- Header -->
        <div class="page-header">
          <div class="page-title-group">
